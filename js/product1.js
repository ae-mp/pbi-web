...
const productData = {
    ...
    qs6pro: {
        ...
        specs: [
            { label: "Dimensions", value: "54.7 x 33.8 x 52.2 cm (H x D x W)" },
            { label: "Block Format", value: "Interchangeable" },
            { label: "Display Type", value: "12 inch Color Touchscreen" },
            { label: "Sensitivity", value: "Single copy detection" },
            { label: "Run Time", value: "70 minutes" },
            { label: "Connectivity", value: "Ethernet, USB" }
        ],
        applications: "Besides PCR, QS6 Pro can run LinkSeq Kits both B27 and Typing of 11 Loci"
    },
    adamii: {
        title: "ADAM II",
